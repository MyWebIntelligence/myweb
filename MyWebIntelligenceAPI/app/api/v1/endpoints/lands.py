...
from app.schemas.job import CrawlRequest, CrawlJobStatus
...
@router.post("/{land_id}/crawl", response_model=CrawlJobStatus)
async def crawl_land(
    ...
    if not land_obj or land_obj.owner_id != current_user.id:
        raise HTTPException(
